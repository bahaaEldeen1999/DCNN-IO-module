...
set output_dir "${ekit_dir}/outputs"
...
set rtl_list { ram.v }
#set rtl_list { "${demo_adder_rtl_dir}/ram.v" }

#set macro_libs
set std_vlt_lib "$library_path/NangateOpenCellLibrary_45nm_LVT_worst_low_conditional_nldm.lib"
set tech_file   "$library_path/NangateOpenCellLibrary.tech.lef"
set lef_files   "$library_path/NangateOpenCellLibrary_LVT.macro.lef"
