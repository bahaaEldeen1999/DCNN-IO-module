...
#set MGC_libDbPath     "/home/vlsi/Desktop/Lab3PnR/work/dbs/libs.db/"

## This section contains variables related to tech files 

set MGC_physical_library_tech   "/home/vlsi/Desktop/Lab3PnR/lib_data/NangateOpenCellLibrary.tech.lef"            ; # REQUIRED: Path to Tech LEF file. Typically used for 40nm and above
set MGC_physical_libraries      "/home/vlsi/Desktop/Lab3PnR/lib_data/NangateOpenCellLibrary.macro.lef"            ; # REQUIRED: Path to standard cell and macro LEF files. For example lef/std_cell.lef
...
set MGC_parasitic_library(new_rc) /home/vlsi/Desktop/Lab3PnR/lib_data/NCSU_FreePDK_45nm.ptf
...
set MGC_timing_library(new_pvt) /home/vlsi/Desktop/Lab3PnR/lib_data/NangateOpenCellLibrary_typical.lib
...
##########################################################################################################################
set MGC_importVerilogNetlist "/home/vlsi/Desktop/Lab3Syn/outputs/verilog/demo_adder.syn.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "DMA"                     ; # REVIEW  : Name of top level module in verilog netlist(s).
set MGC_nrf_floorplanning    "auto"                     ; # REVIEW  : Type floorplanning to be performed: auto | manual | none
#set MGC_floorLoadDefFile     "/home/vlsi/Desktop/Lab3Syn/outputs_adder/floorplan/demo_ripple_adder.def"                     ; # REVIEW  : Path to floorPlan def if available
...
set MGC_floorplan_tcl_file  "";# "/home/vlsi/Desktop/Lab3PnR/work/import.db/.fp.tcl"                     ; # REVIEW  : Name, including path, of Tcl file with additional floorplanning steps
...
set MGC_importConstraintsFile(new_mode) /home/vlsi/Desktop/Lab3PnR/constraints/demo_adder_func.sdc
...
set MGC_UPF_File                 "/home/vlsi/Desktop/Lab3PnR/constraints/demo_adder.85.upf"         ; # ADVANCED: Unified Power Format (UPF) for defining design power intent.
